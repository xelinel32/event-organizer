              ...
              <div class="CommentsToEventPage">
                ...
                <?php }else{ ?>
                  <form method="post"action="../function/comments_blog.php">
                    ...
                    <textarea style="resize:none;" class="form-control" id="exampleFormControlTextarea1" width= "100%" max-width="450" name="text_comment" id="coment_txtarea" cols="50" rows="5" required placeholder="Розкажіть щось?"></textarea>

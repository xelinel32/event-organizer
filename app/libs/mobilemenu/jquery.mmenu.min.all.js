    ...
    (e[t] = function(e, n, t) {
      ...
      (e[t].prototype = {
        ...
        closePanel: function(e) {
          var n = e.parent();
          n.hasClass(a.vertical) &&
            (n.removeClass(a.opened), this.trigger("closePanel", e));
        },
        ...
        togglePanel: function(e) {
          var n = e.parent();
          n.hasClass(a.vertical) &&
            this[n.hasClass(a.opened) ? "closePanel" : "openPanel"](e);
        },
        ...
        _initPanels: function(n) {
          ...
          this.__refactorClass(d, this.conf.classNames.vertical, "vertical"),
            ...
            d.each(function() {
              var n = e(this),
                s = n;
              n.is("ul, ol")
                ? (n.wrap('<div class="' + a.panel + '" />'), (s = n.parent()))
                : s.addClass(a.panel);
              var i = n.attr("id");
              n.removeAttr("id"),
                s.attr("id", i || t.__getUniqueId()),
                n.hasClass(a.vertical) &&
                  (n.removeClass(t.conf.classNames.vertical),
          ...
          l.each(function() {
            ...
            if (
              (s.is("." + a.panels) || (s.data(i.sub, n), n.data(i.parent, s)),
              !s.children("." + a.next).length &&
        ...
        _initAnchors: function() {
          ...
          l.$body.on(r.click + "-oncanvas", "a[href]", function(s) {
            ...
            if (
              ...
              !r &&
                l &&
                i.is("." + a.listview + " > li > a") &&
                !i.is('[rel="external"]') &&
                !i.is('[target="_blank"]'))
            ) {
              n.__valueOrFn(n.opts.onClick.setSelected, i) &&
        ...
        __valueOrFn: function(e, n, t) {
          return "function" == typeof e
            ? e.call(n[0])
            : "undefined" == typeof e && "undefined" != typeof t ? t : e;
        },
  ...
  (e[t].addons[o] = {
      ...
      if (this.opts[o]) {
        ...
        (a = e[t].glbl),
          ...
          ("top" == s.position || "bottom" == s.position) &&
            (s.zposition = "front"),
          "string" != typeof i.pageSelector &&
            (i.pageSelector = "> " + i.pageNodetype),
    ...
    clickAnchor: function(e) {
      ...
      if (
        t &&
        t.length &&
        (this.conf.clone && (t = n.umm(t)), e.is('[href="#' + t + '"]'))
      )
        return this.open(), !0;
      if (a.$page) {
        var t = a.$page.first().attr("id");
        return t && t.length && e.is('[href="#' + t + '"]')
          ? (this.close(), !0)
          : !1;
      }
    }
          ...
          function() {
            t.$menu.removeClass(n.current).removeClass(n.opened),
              a.$html
                ...
                .removeClass(n.blocking)
                .removeClass(n.modal)
                .removeClass(n.background)
                .removeClass(n.mm(t.opts[o].position))
                .removeClass(n.mm(t.opts[o].zposition)),
    ...
    (e[t].prototype.setPage = function(t) {
      var s = this,
        i = this.conf[o];
      (t && t.length) ||
        ((t = a.$body.find(i.pageSelector)),
        i.noPageSelector.length && (t = t.not(i.noPageSelector.join(", "))),
        t.length > 1 &&
          i.wrapPageIfNeeded &&
          (t = t.wrapAll("<" + this.conf[o].pageNodetype + " />").parent())),
        t.each(function() {
    ...
    (e[t].prototype["_initWindow_" + o] = function() {
      a.$wndw.off(i.keydown + "-" + o).on(i.keydown + "-" + o, function(e) {
        return a.$html.hasClass(n.opened) && 9 == e.keyCode
          ? (e.preventDefault(), !1)
          : void 0;
      });
      var e = 0;
    ...
    (e[t].prototype._initBlocker = function() {
      ...
      this.opts[o].blockUI &&
        (a.$blck ||
          (a.$blck = e(
            '<div id="' + n.blocker + '" class="' + n.slideout + '" />'
          )),
        a.$blck
          .appendTo(a.$body)
          .off(i.touchstart + "-" + o + " " + i.touchmove + "-" + o)
          .on(i.touchstart + "-" + o + " " + i.touchmove + "-" + o, function(
            e
          ) {
            e.preventDefault(),
              e.stopPropagation(),
  ...
  (o[t].addons[n] = {
        ...
        if (
          ...
          this.bind("opened", function() {
            ...
            o(window).on("popstate", function(o) {
              a.$html.hasClass(s.opened)
                ? (o.stopPropagation(), i.close())
    ...
    add: function() {
      return window.history && window.history.pushState
        ? ((s = o[t]._c), (i = o[t]._d), void (e = o[t]._e))
        : void (o[t].addons[n].setup = function() {});
    },
    clickAnchor: function() {}
  }),
        ...
        o.add &&
          this.bind("init", function(n) {
            n.each(function() {
              ...
              n &&
                (n.children("em." + i.counter).length ||
                  n.prepend(t('<em class="' + i.counter + '" />')));
            });
          }),
        o.update &&
    ...
    setup: function() {
      ...
      if (
        ...
        (this.$fixeddivider = i(
          ...
          this.bind("init", function(e) {
            e
              .off(t.scroll + "-dividers " + t.touchmove + "-dividers")
              .on(
                t.scroll + "-dividers " + t.touchmove + "-dividers",
                function() {
                  o.call(n, i(this));
                }
              );
  ...
  (e[n].addons[o] = {
          ...
          y
            ...
            .on(l.events, function(e) {
              ...
              2 == m &&
                ((f =
                  t(w, 10, _) -
                  ("front" == i.opts.offCanvas.zposition ? _ : 0)),
                l.negative && (f = -f),
    ...
    add: function() {
      return "function" != typeof Hammer || Hammer.VERSION < 2
        ? void (e[n].addons[o].setup = function() {})
    ...
    setup: function() {
      if (this.opts.offCanvas) {
        ...
        var a = function(s) {
          ...
          this.__refactorClass(s.find("." + i), i, "slideout").appendTo(
            d.$body
          );
        };
...
!(function(n) {
  ...
  (n[a].addons[t] = {
    ...
    (n[a].configuration[t] = { breadcrumbSeparator: "/" }),
        ...
        this.bind("init", function(a) {
          a.removeClass(s.hasnavbar).each(function() {
            for (
              var a = [],
                t = n(this),
                e = n('<span class="' + s.breadcrumbs + '"></span>'),
                c = n(this)
                  .children()
                  .first(),
                d = !0;
        ...
        this.bind("init", function(n) {
          if (d.add) {
            ...
            a.each(function() {
              ...
              d.search &&
                e("." + l.search, this.$menu).each(function() {
                  var n = e(this),
                    ...
                    b = function() {
                      ...
                      r.scrollTop(0),
                        p
                          ...
                          .removeClass(l.fullsubopensearch),
                        p.each(function() {
                          var n = e(this),
                            a = v;
                          (d.showTextItems ||
                            (d.showSubPanels && n.find("." + l.next))) &&
                            (a = m),
                            e(a, n)
                              .text()
                              .toLowerCase()
                  ...
                  h
                    .off(i.keyup + "-searchfield " + i.change + "-searchfield")
    ...
    setup: function() {
      ...
      this.conf[r],
        ...
        this.bind("init", function(a) {
          ...
          if (
            !this.$indexer &&
            this.$pnls.children("." + n.hasindexer).length
          ) {
                          ...
                          t === !1 &&
                            a ==
                              e(this)
                                ...
                                .slice(0, 1)
                                .toLowerCase() &&
                            (t = e(this).position().top + h);
                        }),
                      r.scrollTop(t !== !1 ? t : d);
                  }
                );
            var t = function(e) {
              i.$menu[(e.hasClass(n.hasindexer) ? "add" : "remove") + "Class"](
                n.hasindexer
              );
            };

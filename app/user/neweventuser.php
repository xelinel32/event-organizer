		...
		<div class="container">
			<div class="row">
				<div class="col-md-8">
					<div class="box_news">
						<div class="newevent">
							<h3>Форма організації вих. роботи</h3>
							<div class="formnewevent">
								<form action="modules/eventsprocess.php" method="post" enctype="multipart/form-data">
									<div class="form-group">
										...
										<textarea required name="preview_event" class="form-control" id="exampleFormControlTextarea1" rows="2" placeholder="Що буде за вих. робота?"></textarea><br>
										<label for="body">Повний опис виховної роботи</label><br>
										<textarea required class="form-control" id="body" name="full_event" cols="80" rows="10" placeholder="Повний опис заходу"></textarea><br>
